...
import offcanvas1 from '../assets/img/menu/offcanvas/offcanvas-1.jpg';
import offcanvas2 from '../assets/img/menu/offcanvas/offcanvas-2.jpg';
import offcanvas3 from '../assets/img/menu/offcanvas/offcanvas-3.jpg';
import offcanvas4 from '../assets/img/menu/offcanvas/offcanvas-4.jpg';
      ...
      <div className="tp-offcanvas-wrapper">
        <div className="tp-offcanvas-top d-flex align-items-center justify-content-between">
          <div className="tp-offcanvas-logo">
            <a href="index.html">
              ...
              <img className="logo-2" src={logoWhite} alt="logo" />
            </a>
          </div>
        ...
        <div className="tp-offcanvas-main">
            ...
            <div className="row gx-2">
              <div className="col-md-3 col-3">
                <div className="tp-offcanvas-gallery-img fix">
                  <a href="#"><img src={offcanvas1} alt="offcanvas1" /></a>
                </div>
              </div>
              <div className="col-md-3 col-3">
                <div className="tp-offcanvas-gallery-img fix">
                  <a href="#"><img src={offcanvas2} alt="offcanvas2" /></a>
                </div>
              </div>
              <div className="col-md-3 col-3">
                <div className="tp-offcanvas-gallery-img fix">
                  <a href="#"><img src={offcanvas3} alt="offcanvas3" /></a>
                </div>
              </div>
              <div className="col-md-3 col-3">
                <div className="tp-offcanvas-gallery-img fix">
                  <a href="#"><img src={offcanvas4} alt="offcanvas4" /></a>
                </div>
              </div>
            </div>
          </div>
          <div className="tp-offcanvas-contact">
            ...
            <ul>
              <li><a href="tel:1245654">+51 977 843 556</a></li>
              <li><a href="mailto:hello@diego.com">SINROLLO.PE@GMAIL.COM</a></li>
              <li><a href="#">AV PROCERES DE HUANDOY 489 - LOS OLIVOS - LIMA - PERU</a></li>
            </ul>
          </div>
          <div className="tp-offcanvas-social">
            <h3 className="tp-offcanvas-title sm">Síguenos</h3>
            <ul>
              <li>
                <a href="#">
              ...
              <li>
                <a href="#">
                  <svg width="18" height="11" viewBox="0 0 18 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M16.1125 1.44434H11.668" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                </a>
              </li>
              <li>
